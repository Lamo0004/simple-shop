    ...
    <div className="flex flex-col items-center gap-6 m-4">
      ...
      <div className="flex w-full max-w-[500px]">
        {images.map((src, index) => (
          <div
            key={index}
            className={`shadow-sm relative w-1/3 aspect-square cursor-pointer overflow-hidden border-2 transition duration-200 ${mainImage === src ? "border-orange-400" : "border-transparent"
              }`}
